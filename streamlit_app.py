...
with tab4:
    ...
    # Marked as raw string string format via 'r' prefix identifier rules to resolve sub-escape crash sequences
    clear_text_script = r"""(function() {
    // =========================================================================
    ...
    console.log("Ultimate Unified Engine Active: Calendar Bypass & Auto-Mirror running smoothly!");
})();"""

    st.code(clear_text_script, language="javascript")
